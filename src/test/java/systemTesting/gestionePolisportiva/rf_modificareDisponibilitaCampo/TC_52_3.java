...
public class TC_52_3 {
    ...
    public void TC523(){
        ...
        driver.get("http://localhost:8080/PitchFinder_war_exploded/ModificaDispCampoController?data=2021-01-21&inizio=&fine=20%3A16&idcampo=1002&Occupa=Occupa");
        assertEquals("La modifica fallisce perché l’orario di inizio non è stato selezionato",
