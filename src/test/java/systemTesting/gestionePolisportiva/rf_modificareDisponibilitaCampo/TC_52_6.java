...
public class TC_52_6 {
    ...
    public void TC527(){
        ...
        driver.get("http://localhost:8080/PitchFinder_war_exploded/ModificaDispCampoController?data=2021-01-21&inizio=04%3A51&fine=56789dsd&idcampo=1002&Occupa=Occupa");
        assertEquals("La modifica fallisce perché l’orario di fine non rispetta il formato",
