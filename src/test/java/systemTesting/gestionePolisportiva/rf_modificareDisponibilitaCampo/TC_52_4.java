...
public class TC_52_4 {
    ...
    public void TC524(){
        ...
        driver.get("http://localhost:8080/PitchFinder_war_exploded/ModificaDispCampoController?data=2021-01-21&inizio=weds&fine=20%3A16&idcampo=1002&Occupa=Occupa");
        assertEquals("La modifica fallisce perché l’orario di inizio non rispetta il formato",
