...
//formato non posso sbagliare
        ...
        driver.get("http://localhost:8080/PitchFinder_war_exploded/DareDispCampoController?data=2021-01-29&inizio=09%3A00&fine=12sdad%3A00&idcampo=1002&Conferma=Conferma");
        try {
            assertEquals("Non viene memorizzata la disponibilità poiché il formato dell’orario di fine non è valido.",
