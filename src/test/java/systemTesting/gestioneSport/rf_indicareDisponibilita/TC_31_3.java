...
public class TC_31_3 {
    ...
    public void TC313() throws Exception {
        ...
        try {
            assertEquals("Non viene memorizzata la disponibilità poiché l'orario di inizio non è stata selezionato.",
                    driver.findElement(By.id("small-creation-timestr")).getText());
        } catch (Error e) {
