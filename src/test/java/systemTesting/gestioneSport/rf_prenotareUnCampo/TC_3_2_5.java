...
public class TC_3_2_5 {
    ...
    public void testTC325() throws Exception {
        ...
        driver.findElement(By.id("creation-timeend")).sendKeys("");
        driver.findElement(By.id("form-creation")).click();
        assertEquals("L'orario di fine non è selezionato", driver.findElement(By.id("small-creation-timeend")).getText());
    }
