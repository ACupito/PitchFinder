...
public class TC_3_2_7 {
    ...
    public void testTC327() throws Exception {
        ...
        driver.findElement(By.id("creation-player")).sendKeys("90");
        driver.findElement(By.id("form-creation")).click();
        assertEquals("Valore di Numero Giocatori non valido.",
                driver.findElement(By.id("small-creation-player")).getText());
    }
