...
public class TC_3_2_6 {
    ...
    @Test
    public void testTC325() throws Exception {
        ...
        driver.findElement(By.id("creation-timeend")).sendKeys("diciassette");
        driver.findElement(By.id("form-creation")).click();
        assertEquals("L'orario di fine non rispetta il formato", driver.findElement(By.id("small-creation-timeend")).getText());
    }
