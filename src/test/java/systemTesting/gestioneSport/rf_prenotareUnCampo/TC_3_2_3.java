...
public class TC_3_2_3 {
    ...
    @Test
    public void testTC323() throws Exception {
        ...
        driver.findElement(By.id("creation-timestr")).sendKeys("");
        driver.findElement(By.id("form-creation")).click();
        driver.findElement(By.id("match-section")).click();
        assertEquals("L'orario di inizio non è selezionato", driver.findElement(By.id("small-creation-timestr")).getText());
    }
