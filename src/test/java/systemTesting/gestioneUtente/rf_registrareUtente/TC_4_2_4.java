...
public class TC_4_2_4 {
    ...
    @Test
    public void testTC424() throws Exception {
        ...
        driver.findElement(By.id("username_")).sendKeys("Memex99");
        driver.findElement(By.xpath("//div[5]")).click();
        driver.findElement(By.id("username_")).click();
        driver.findElement(By.id("username_")).clear();
        driver.findElement(By.id("username_")).sendKeys("memex99");
        assertEquals("La username inserita non rispetta il formato richiesto",
