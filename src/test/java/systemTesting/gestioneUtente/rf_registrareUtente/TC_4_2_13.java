...
public class TC_4_2_13 {
    ...
    public void setUp() throws Exception {
        ...
        as.removeUtente("Hey1000");
    }


    @Test
    public void testTC4213() throws Exception {
        driver.get("http://localhost:8080/PitchFinder_war_exploded/autentication?flag=-1");
        driver.findElement(By.id("email")).click();
        driver.findElement(By.id("email")).clear();
        driver.findElement(By.id("email")).sendKeys("hey1000@gmail.com");
        driver.findElement(By.id("username_")).click();
        driver.findElement(By.id("username_")).clear();
        driver.findElement(By.id("username_")).sendKeys("Hey1000");
        ...
        driver.findElement(By.id("cognome")).sendKeys("Hey");
        driver.findElement(By.id("password_")).click();
        driver.findElement(By.id("password_")).clear();
        driver.findElement(By.id("password_")).sendKeys("Esse3");
        driver.findElement(By.id("data")).click();
        driver.findElement(By.id("data")).clear();
        driver.findElement(By.id("data")).sendKeys("1999-05-05");

        assertEquals("Registrati",
