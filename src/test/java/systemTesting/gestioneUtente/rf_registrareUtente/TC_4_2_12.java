...
public class TC_4_2_12 {
    ...
    @Test
    public void testTC4212() throws Exception {
        ...
        driver.findElement(By.id("data")).sendKeys("1999-05-2");

        assertEquals("La data di nascita non rispetta il formato corretto",
                driver.findElement(By.id("div_data")).getText());
    }
