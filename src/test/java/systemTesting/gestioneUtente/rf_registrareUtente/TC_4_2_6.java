...
public class TC_4_2_6 {
    ...
    @Test
    public void testTC426() throws Exception {
        driver.get("http://localhost:8080/PitchFinder_war_exploded/autentication?flag=-1");
        driver.findElement(By.id("nome")).clear();
        driver.findElement(By.id("nome")).sendKeys("Emanuele99");

        assertEquals("Il nome inserito non rispetta il formato richiesto",
