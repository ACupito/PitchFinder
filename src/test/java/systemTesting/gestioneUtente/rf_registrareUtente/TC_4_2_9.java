...
public class TC_4_2_9 {
    ...
    @Test
    public void testTC429() throws Exception {
        driver.get("http://localhost:8080/PitchFinder_war_exploded/autentication?flag=-1");
        driver.findElement(By.id("password_")).clear();
        driver.findElement(By.id("password_")).sendKeys("Esse333333333333333333333333333333333" +
                "333333333333333");

        assertEquals("La password inserita non rispetta la lunghezza corretta",
