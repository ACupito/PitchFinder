...
public class TC_4_2_10 {
    ...
    @Test
    public void testTC4210() throws Exception {
        ...
        assertEquals("La password inserita non rispetta il formato richiesto",
                driver.findElement(By.id("div_password_")).getText());
    }
