...
public class TC_4_2_8 {
    ...
    @Test
    public void testTC428() throws Exception {
        ...
        driver.findElement(By.id("cognome")).sendKeys("Mezzi99");

        assertEquals("Il cognome inserito non rispetta il formato richiesto",
