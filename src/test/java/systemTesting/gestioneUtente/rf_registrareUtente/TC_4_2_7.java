...
public class TC_4_2_7 {
    ...
    @Test
    public void testTC427() throws Exception {
        ...
        driver.findElement(By.id("cognome")).sendKeys("Mezziiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii");

        assertEquals("Il cognome inserito non rispetta la lunghezza corretta",
                driver.findElement(By.id("div_cognome")).getText());
    }
